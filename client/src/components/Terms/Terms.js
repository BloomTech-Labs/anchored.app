  ...
  return (
    <TermsContainer>
      ...
      <Paragraph>
        ...
        Proofd does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Proofd,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Proofd shall not be liable for the
      ...
      <Paragraph>
        Proofd reserves the right to monitor all Comments and to remove any
      ...
      <Paragraph>
        You hereby grant Proofd a non-exclusive license to use, reproduce, edit
      ...
      <Paragraph>
        ...
        the hyperlink compensates the absence of Proofd; and (d) the link is in
      ...
      <Paragraph>
        ...
        e-mail to Proofd. Please include your name, your organization name,
      ...
      <Paragraph>
        No use of Proofd's logo or other artwork will be allowed for linking
